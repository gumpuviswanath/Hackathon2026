Feature: Account Management
  ...
  Scenario: Verify Account Management page loads correctly
    Given User registers a new customer with name "Carla Mendes" mobile "9876500003" and government id "AADHAR500003"
  ...
  Scenario: Validation - a customer without KYC approval is not eligible to open an account
    Given User registers a new customer with name "Eve Turner" mobile "9876500005" and government id "AADHAR500005"
    When User navigates to the Account module
  ...
  Scenario: Successfully open a new account for a KYC-approved customer
    Given User registers a new customer with name "Frank Wilson" mobile "9876500006" and government id "AADHAR500006"

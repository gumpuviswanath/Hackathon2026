Feature: Account Management
  ...
  Scenario: Verify Account Management page loads correctly
    Given User registers a new customer with name "Carla Mendes" mobile "9876500003" government id "AADHAR500003" email "carla.mendes@example.com" and pan number "ABCDE1234F"
  ...
  Scenario: Validation - a customer without KYC approval is not eligible to open an account
    Given User registers a new customer with name "Eve Turner" mobile "9876500005" government id "AADHAR500005" email "eve.turner@example.com" and pan number "ABCDE1234G"
    When User navigates to the Account module
  ...
  Scenario: Successfully open a new account for a KYC-approved customer
    Given User registers a new customer with name "Frank Wilson" mobile "9876500006" government id "AADHAR500006" email "frank.wilson@example.com" and pan number "ABCDE1234H"
